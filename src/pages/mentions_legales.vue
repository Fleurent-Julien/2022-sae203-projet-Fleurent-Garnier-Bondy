...
<template>
    ...
    <p class="mx-5 text-lg">Produit Vert est un site créé par 3 étudiants en MMI (Métiers du Multimédia et de l’Internet). Le siège social est situé au 4 place Tharradin, 25200, Montbéliard, France. Nous respectons votre droit à la vie privée et traitons uniquement les renseignements personnels que vous nous fournissez conformément aux lois sur la protection des données en vigueur.</p>
        ...
        <p class="mx-5 text-lg">Lorsque que vous effectuez un achat sur notre site, nous recueillons les renseignements personnels que vous nous fournissez, tels que votre nom, votre adresse et votre adresse e-mail.</p>
   <p class="mx-5 text-lg mt-2"> Aussi lorsque vous naviguez sur notre site, nous recevons également automatiquement l’adresse de protocole Internet (adresse IP) de votre ordinateur, qui nous permet d’obtenir plus de détails au sujet du navigateur et du système d’exploitation que vous utilisez.</p>

        <h2 class="m-5 font-bold text-2xl">Exploitation des données vous concernant</h2>
    ...
    <p class="mx-5 text-lg">A contrario, à défaut de sélection et si vous ne vous êtes pas opposés lors de la création de votre compte, vous serez susceptible de recevoir les informations sur l'actualité de Produit Vert et les mises à jour sur le site que vous êtes actuellement en train de consulter.A contrario, à défaut de sélection et si vous ne vous êtes pas opposés lors de la création de votre compte, vous serez susceptible de recevoir les informations sur l'actualité d’Axolott et les mises à jour sur le site que vous êtes actuellement en train de consulter.</p>
            ...
            <p class="mx-5 text-lg">Nous pouvons vous proposer des alertes afin d’être tenues informés par e-mail ou via un post Instagram d’une actualités vous intéressant.</p>

            <h2 class="m-5 font-bold text-2xl">Questions et commentaires</h2>

                <p class="mx-5 my-2 text-lg">En cas de questions sur notre traitement des informations personnelles, vous pouvez contacter notre délégué à la protection des données, par courrier à l'adresse 4 place Tharradin, 25200, Montbéliard, France , États-Unis, par e-mail à l’adresse contact.produitvert@gmail.com ou par téléphone au 03 81 99 47 34.</p>
    <p class="mx-5 my-2 text-lg">Pour toute plainte au sujet de notre Site Web, veuillez nous contacter aux coordonnées suivantes :</p>
    <p class="mx-5 my-2 text-lg">Adresse : 4 place Tharradin, 25200, Montbéliard, France</p>
    ...
    <p class="mx-5 my-2 text-lg">Adresse du siège social : 4 place Tharradin, 25200, Montbéliard, France</p>
    <p class="mx-5 my-2 text-lg">Renseignements concernant l’hébergeur du site (nom, dénomination ou raison sociale, adresse et numéro de téléphone).</p>
    <p class="mx-5 my-2 text-lg">Nom : Infomaniak</p>
